...
class YOLOV5CFG2COCO():
    def __init__(self, yaml_path, root_data_dir):
        ...
        print(self.train_path, self.val_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_data_dir', default="../data/ship-detection-v1")
    args = parser.parse_args()

    converter = YOLOV5CFG2COCO(args.yaml_path, args.root_data_dir)
    converter.generate()